...
(function () {
  ...
  var OP_CSS = [
    ...
    '.vl-meet-h3{font-size:15.5px;font-weight:700;color:#1A1829;margin:18px 0 8px;font-family:"Plus Jakarta Sans",sans-serif;}',
  ...
  function injectPairStyles() {
    ...
    st.textContent = [
      ...
      '.vl-pair-h{font-size:17px;font-weight:700;color:#231d3f;margin:6px 0 14px;font-family:inherit;}',
      ...
      '.vl-pair-ava-mark{width:64px;height:64px;border-radius:50%;flex:0 0 auto;display:flex;align-items:center;justify-content:center;background:#F9E7DC;color:#B85C2B;font-weight:700;font-size:22px;border:2.5px solid #fff;box-shadow:0 3px 10px rgba(51,48,74,.14);}',
      '.vl-pair-who{flex:1 1 240px;min-width:0;}',
      '.vl-pair-name{font-weight:700;font-size:15.5px;color:#231d3f;}',
  ...
  function injectUpdateStyles() {
    ...
    st.textContent = [
      ...
      '.vl-upd-date b{display:block;font:700 17px/1.1 ' + F + ';}',
  ...
  function injectNpStyles() {
    ...
    st.textContent = [
      ...
      '.vl-np h1{font-size:26px;font-weight:700;color:#231d3f;margin:0 0 10px;font-family:inherit;}',
  ...
  var _PAY_ICONS = {
    ...
    // Official Zelle logomark (brand SVG supplied by Francesca 2026-07-20),
    // currentColor like the rest so it flips violet->white with its chip.
    zelle:   '<svg viewBox="0 0 59.1 100" width="20" height="20" fill="currentColor" aria-hidden="true"><path d="M58.7,83.4c-0.1-0.1-0.1-0.1-0.2-0.2l-0.1-0.1c-2.7-2.8-4.8-6.1-6.4-9.8c-0.2-0.6-0.8-1-1.4-1h-1.3h-5.8H20.6l36.6-46.9c0.2-0.3,0.3-0.6,0.3-1v-9.1c0-0.9-0.7-1.6-1.6-1.6H38.8h-0.7h-2V0.8c0-0.4-0.4-0.8-0.8-0.8H35h-0.3H23.9h-0.4h-0.3c-0.4,0-0.8,0.4-0.8,0.8v13.1h-2.8H19H3.1c-0.9,0-1.6,0.7-1.6,1.6V26c0,0.9,0.7,1.6,1.6,1.6h33.6L0.3,74C0.1,74.3,0,74.7,0,75v9.5c0,0.9,0.7,1.6,1.6,1.6h20.9v13.1c0,0.4,0.4,0.8,0.8,0.8h0.3H24h10.8H35h0.4c0.4,0,0.8-0.4,0.8-0.8V86.1H45h11.3h1.3c0.6,0,1.2-0.4,1.4-1C59.3,84.6,59.1,83.9,58.7,83.4"/></svg>'
  };
  ...
  var REV_BADGES = {};
  // Font Awesome Free 7.3.1 compass (fontawesome.com/license/free) — matches
  // the Scout badge glyph on /account.
  var EARLY_ICO = '<svg width="9" height="9" viewBox="0 0 640 640" fill="currentColor" aria-hidden="true"><path d="M528 320C528 205.1 434.9 112 320 112C205.1 112 112 205.1 112 320C112 434.9 205.1 528 320 528C434.9 528 528 434.9 528 320zM64 320C64 178.6 178.6 64 320 64C461.4 64 576 178.6 576 320C576 461.4 461.4 576 320 576C178.6 576 64 461.4 64 320zM370.7 389.1L226.4 444.6C207 452.1 187.9 433 195.4 413.6L250.9 269.3C254.2 260.8 260.8 254.2 269.3 250.9L413.6 195.4C433 187.9 452.1 207 444.6 226.4L389.1 370.7C385.8 379.2 379.2 385.8 370.7 389.1zM352 320C352 302.3 337.7 288 320 288C302.3 288 288 302.3 288 320C288 337.7 302.3 352 320 352C337.7 352 352 337.7 352 320z"/></svg>';
