...
(function () {
  ...
  var CH = {
    ...
    // Marketing tools (/vendor-dashboard/marketing): the rotating promo button
    // and the Showcase-of-the-week link on the storefront.
    cta:       { label: 'Promo',     verb: 'clicked your promo button', cls: 'website', icon: 'M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z' },
    showcase:  { label: 'Showcase',  verb: 'opened your showcase link', cls: 'website', icon: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20z|M2 12h20|M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z' }
  };
