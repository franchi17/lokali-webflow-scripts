...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      '.lkf-h1{font-size:26px;font-weight:700;margin:0 0 6px;}',
      ...
      '.lkf-h2{font-size:17px;font-weight:700;margin:0 0 4px;}',
      ...
      '.lkf-stat b{display:block;font-size:24px;font-weight:700;color:#6002EE;line-height:1.15;font-variant-numeric:tabular-nums;}',
