...
(function () {
  ...
  var LUI_CSS = [
    ...
    '.lok-hdl .text-block-33{font-size:22px!important;font-weight:700!important;color:#1A1829!important;letter-spacing:-.01em;line-height:1.2!important;margin:0!important;font-family:' + LUI_FONT + '!important;}',
    ...
    '.lok-empty h3{font-size:16px;font-weight:700;margin:0 0 8px;color:#1A1829;}',
    ...
    '.lok-steps li i{width:24px;height:24px;border-radius:50%;background:#F3EBFF;color:#6002EE;font-style:normal;font-weight:700;font-size:11px;display:flex;align-items:center;justify-content:center;}',
  ...
  var LUI_FORM_CSS = [
    ...
    '.lok-fs-h h3{font-size:16px;font-weight:700;margin:0;display:flex;align-items:center;gap:10px;letter-spacing:-.01em;color:#1A1829;line-height:1.3;font-family:' + LUI_FONT + ';}',
    '.lok-fs-num{width:24px;height:24px;border-radius:50%;background:#6002EE;color:#fff;font-style:normal;font-weight:700;font-size:12px;display:inline-flex;align-items:center;justify-content:center;flex-shrink:0;}',
    ...
    '.lok-sw-live-t{font:700 15px/1.3 ' + LUI_FONT + ';color:#1A1829;}',
