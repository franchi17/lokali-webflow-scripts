...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      '.lkw h1{font-size:34px;line-height:1.15;font-weight:800;margin:6px 0 10px;}',
      '.lkw-lede{font-size:17px;line-height:1.6;color:#4A4761;margin:0 0 26px;max-width:60ch;}',
      '.lkw-day{font-size:13px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:#6B6880;margin:26px 0 10px;}',
      ...
      '.lkw-place{font-size:17px;font-weight:800;line-height:1.3;margin:0;overflow-wrap:anywhere;}',
      ...
      '.lkw-av{flex:none;width:36px;height:36px;border-radius:50%;background:#F3EBFF;color:#6002EE;font-size:12px;font-weight:800;display:flex;align-items:center;justify-content:center;overflow:hidden;}',
      ...
      '.lkw-empty h2{font-size:19px;font-weight:800;margin:0 0 8px;}',
